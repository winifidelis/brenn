...
<head>
    ...
    <!-- site Favicon -->
    <link rel="icon" href="{{asset('assets_html/images/favicon/favicon.png')}}" sizes="32x32" />
    <link rel="apple-touch-icon" href="{{asset('assets_html/images/favicon/favicon.png')}}" />
    <meta name="msapplication-TileImage" content="{{asset('assets_html/images/favicon/favicon.png')}}" />
...
<body class="product_page">
                    ...
                    <div class="ec-flex">
                        ...
                        <div class="align-self-center">
                            <div class="header-logo">
                                <a href="index.html"><img src="{{asset('assets_html/images/logo/logo.png')}}" alt="Site Logo" /><img class="dark-logo" src="{{asset('assets_html/images/logo/dark-logo.png')}}" alt="Site Logo" style="display: none;" /></a>
                            </div>
                        </div>
                        <!-- Ec Header Logo End -->
                                    ...
                                    <ul class="mega-menu d-block">
                                        ...
                                        <li>
                                            <ul class="ec-main-banner w-100">
                                                <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img class="img-responsive" src="{{asset('assets_html/images/menu-banner/1.jpg')}}" alt=""></a></li>
                                                <li><a class="p-0" href="shop-left-sidebar-col-4.html"><img class="img-responsive" src="{{asset('assets_html/images/menu-banner/2.jpg')}}" alt=""></a></li>
                                                <li><a class="p-0" href="shop-right-sidebar-col-3.html"><img class="img-responsive" src="{{asset('assets_html/images/menu-banner/3.jpg')}}" alt=""></a></li>
                                                <li><a class="p-0" href="shop-right-sidebar-col-4.html"><img class="img-responsive" src="{{asset('assets_html/images/menu-banner/4.jpg')}}" alt=""></a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <ul>
                        ...
                        <li><a href="javascript:void(0)">Categories</a>
                            <ul class="sub-menu">
                                ...
                                <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img class="img-responsive" src="{{asset('assets_html/images/menu-banner/1.jpg')}}" alt=""></a>
                                </li>
                            </ul>
                        </li>
        ...
        <div class="ec-cart-inner">
            <div class="ec-cart-top">
                ...
                <ul class="eccart-pro-items">
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img src="{{asset('assets_html/images/product-image/6_1.jpg')}}" alt="product"></a>
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img src="{{asset('assets_html/images/product-image/12_1.jpg')}}" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <li>
                        <a href="product-left-sidebar.html" class="sidekka_pro_img"><img src="{{asset('assets_html/images/product-image/3_1.jpg')}}" alt="product"></a>
                        <div class="ec-pro-content">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-3 ec-footer-contact">
                            <div class="ec-footer-widget">
                                <div class="ec-footer-logo"><a href="#"><img src="{{asset('assets_html/images/logo/footer-logo.png')}}" alt=""><img class="dark-footer-logo" src="{{asset('assets_html/images/logo/dark-logo.png')}}" alt="Site Logo" style="display: none;" /></a></div>
                        ...
                        <div class="col footer-bottom-right">
                            <div class="footer-bottom-payment d-flex justify-content-end">
                                <div class="payment-link">
                                    <img src="{{asset('assets_html/images/icons/payment.png')}}" alt="">
                                </div>
                    ...
                    <div class="row ec-product-360">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="ec-360-panel ec-360-panel-default">
                                <a class="btn btn-default ec-360-btn qty_close" data-bs-dismiss="modal" aria-label="Close">×</a>
                                <div class="ec-360-panel-body">
                                    <div id="circlr" class="ec-circlr">
                                        <img data-src="{{asset('assets_html/images/product-360/00.jpg')}}" src="{{asset('assets_html/images/product-360/00.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/01.jpg')}}" src="{{asset('assets_html/images/product-360/01.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/02.jpg')}}" src="{{asset('assets_html/images/product-360/02.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/03.jpg')}}" src="{{asset('assets_html/images/product-360/03.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/04.jpg')}}" src="{{asset('assets_html/images/product-360/04.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/05.jpg')}}" src="{{asset('assets_html/images/product-360/05.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/06.jpg')}}" src="{{asset('assets_html/images/product-360/06.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/07.jpg')}}" src="{{asset('assets_html/images/product-360/07.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/08.jpg')}}" src="{{asset('assets_html/images/product-360/08.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/09.jpg')}}" src="{{asset('assets_html/images/product-360/09.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/10.jpg')}}" src="{{asset('assets_html/images/product-360/10.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/11.jpg')}}" src="{{asset('assets_html/images/product-360/11.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/12.jpg')}}" src="{{asset('assets_html/images/product-360/12.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/13.jpg')}}" src="{{asset('assets_html/images/product-360/13.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/14.jpg')}}" src="{{asset('assets_html/images/product-360/14.jpg')}}" alt="product image">
                                        <img data-src="{{asset('assets_html/images/product-360/15.jpg')}}" src="{{asset('assets_html/images/product-360/15.jpg')}}" alt="product image">
                                        <div id="loader" class="ec-img-loader"></div>
                                    </div>
                                </div>
                                <p class="ec-tool-play">
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.play(); return false;"><img src="{{asset('assets_html/images/icons/play.svg')}}" class="svg_img pro_svg" alt="play image" /></a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.stop(); return false;"><img src="{{asset('assets_html/images/icons/stop.svg')}}" class="svg_img pro_svg" alt="stop image" /></a>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="ec-tool-box-sec">
                            ...
                            <div class="ec-tool-box-2 space-b-15">
                                <h4>Rotation</h4>
                                <p>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.turn(9); return false;">9</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.turn(8); return false;">8</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.turn(7); return false;">7</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.turn(6); return false;">6</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.turn(5); return false;">5</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.turn(4); return false;">4</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.turn(3); return false;">3</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.turn(2); return false;">2</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.turn(1); return false;">1</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.turn(0); return false;">0</a>
                                </p>
                            </div>
                            ...
                            <div class="ec-tool-box-2">
                                <h4>Goto n frame</h4>
                                <p>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.go(9); return false;">9</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.go(8); return false;">8</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.go(7); return false;">7</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.go(6); return false;">6</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.go(5); return false;">5</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.go(4); return false;">4</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.go(3); return false;">3</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.go(2); return false;">2</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.go(1); return false;">1</a>
                                    <a href="#" class="btn btn-default ec-360-btn" onclick="crl.go(0); return false;">0</a>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-5 col-sm-12 col-xs-12">
                            ...
                            <div class="qty-product-cover">
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('assets_html/images/product-image/3_1.jpg')}}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('assets_html/images/product-image/3_2.jpg')}}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('assets_html/images/product-image/3_3.jpg')}}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('assets_html/images/product-image/3_4.jpg')}}" alt="">
                                </div>
                                <div class="qty-slide">
                                    <img class="img-responsive" src="{{asset('assets_html/images/product-image/3_5.jpg')}}" alt="">
                                </div>
                            </div>
                            ...
                            <div class="quickview-pro-content">
                                ...
                                <div class="ec-quickview-qty">
                                    ...
                                    <div class="ec-quickview-cart ">
                                        <button class="btn btn-primary"><img src="{{asset('assets_html/images/icons/cart.svg')}}" class="svg_img pro_svg" alt="" /> Add To Cart</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="ec-nav-panel">
                <div class="ec-nav-panel-icons">
                    <a href="#ec-mobile-menu" class="navbar-toggler-btn ec-header-btn ec-side-toggle"><img src="{{asset('assets_html/images/icons/menu.svg')}}" class="svg_img header_svg" alt="" /></a>
                </div>
                <div class="ec-nav-panel-icons">
                    <a href="#ec-side-cart" class="toggle-cart ec-header-btn ec-side-toggle"><img src="{{asset('assets_html/images/icons/cart.svg')}}" class="svg_img header_svg" alt="" /><span class="ec-cart-noti ec-header-count cart-count-lable">3</span></a>
                </div>
                <div class="ec-nav-panel-icons">
                ...
                <div class="ec-nav-panel-icons">
                    <a href="login.html" class="ec-header-btn"><img src="{{asset('assets_html/images/icons/user.svg')}}" class="svg_img header_svg" alt="icon" /></a>
                </div>
                        ...
                        <a class="ec-list" data-number="918866774266" data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                            <div class="d-flex bd-highlight">
                                ...
                                <div class="ec-img-cont">
                                    <img src="{{asset('assets_html/images/whatsapp/profile_01.jpg')}}" class="ec-user-img" alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266" data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{asset('assets_html/images/whatsapp/profile_02.jpg')}}" class="ec-user-img" alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266" data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{asset('assets_html/images/whatsapp/profile_03.jpg')}}" class="ec-user-img" alt="Profile image">
                    ...
                    <li>
                        <a class="ec-list" data-number="918866774266" data-message="Please help me! I have got wrong product - ORDER ID is : #654321485">
                            <div class="d-flex bd-highlight">
                                <!-- Profile Picture -->
                                <div class="ec-img-cont">
                                    <img src="{{asset('assets_html/images/whatsapp/profile_04.jpg')}}" class="ec-user-img" alt="Profile image">
                                    <span class="ec-status-icon ec-offline"></span>
                                </div>
                                <!-- Display Name & Last Seen -->
                                <div class="ec-user-info">
    ...
    <div class="ec-tools-sidebar">
        ...
        <a href="#" class="ec-tools-sidebar-toggle in-out">
            <img alt="icon" src="{{asset('assets_html/images/common/settings.png')}}" />
        </a>
