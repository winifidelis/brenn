...
<div id="ec-mobile-menu" class="ec-side-cart ec-mobile-menu">
    <div class="ec-menu-title">
        <span class="menu_title">Meu Menu</span>
        ...
        <div class="ec-menu-content">
            <ul>
                ...
                <li><a href="javascript:void(0)">Produtos</a>
                    <ul class="sub-menu">
                        <li><a href="javascript:void(0)">Futevôlei</a>
                            <ul class="sub-menu">
                ...
                <li><a href="javascript:void(0)">Atletas</a>
                    <ul class="sub-menu">
                        <li><a href="javascript:void(0)">Futevôlei</a>
                            <ul class="sub-menu">
                        ...
                        <li><a href="javascript:void(0)">Vôlei</a>
                            <ul class="sub-menu">
                                <li><a href="#">João</a></li>
                                <li><a href="#">José</a></li>
                        ...
                        <li><a href="javascript:void(0)">Futebol</a>
                            <ul class="sub-menu">
                        ...
                        <li><a href="javascript:void(0)">Natação</a>
                            <ul class="sub-menu">
