...
<head>
    ...
    <title>Brenn Sports - Administração.</title>
    ...
    <!-- PLUGINS CSS STYLE -->
    <link href="{{asset('assets_admin/plugins/daterangepicker/daterangepicker.css')}}" rel="stylesheet">
    <link href="{{asset('assets_admin/plugins/simplebar/simplebar.css')}}" rel="stylesheet" />

    <!-- Ekka CSS -->
    <link id="ekka-css" href="{{asset('assets_admin/css/ekka.css')}}" rel="stylesheet" />

    <!-- FAVICON -->
    <link href="{{asset('assets_admin/img/favicon.png')}}" rel="shortcut icon" />
...
<body class="ec-header-fixed ec-sidebar-fixed ec-sidebar-light ec-header-light" id="body">
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="media">
                                                        <div class="media-image mr-3 rounded-circle">
                                                            <a href="profile.html"><img class="profile-img rounded-circle w-45" src="{{asset('assets_admin/img/user/u1.jpg')}}" alt="customer image"></a>
                                                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media">
                                                        <div class="media-image mr-3 rounded-circle">
                                                            <a href="profile.html"><img class="profile-img rounded-circle w-45" src="{{asset('assets_admin/img/user/u2.jpg')}}" alt="customer image"></a>
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                            <a href="profile.html">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media">
                                                        <div class="media-image mr-3 rounded-circle">
                                                            <a href="profile.html"><img class="profile-img rounded-circle w-45" src="{{asset('assets_admin/img/user/u3.jpg')}}" alt="customer image"></a>
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                            <a href="profile.html">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media">
                                                        <div class="media-image mr-3 rounded-circle">
                                                            <a href="profile.html"><img class="profile-img rounded-circle w-45" src="{{asset('assets_admin/img/user/u4.jpg')}}" alt="customer image"></a>
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                            <a href="profile.html">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="media">
                                                        <div class="media-image mr-3 rounded-circle">
                                                            <a href="profile.html"><img class="profile-img rounded-circle w-45" src="{{asset('assets_admin/img/user/u5.jpg')}}" alt="customer image"></a>
                                                        </div>
                                                        <div class="media-body align-self-center">
                                                            <a href="profile.html">
                                ...
                                <div class="card-body mt-10px mb-10px py-0">
                                    <div class="row media d-flex pt-15px pb-15px">
                                        <div class="col-lg-3 col-md-3 col-2 media-image align-self-center rounded">
                                            <a href="#"><img src="{{asset('assets_admin/img/products/p1.jpg')}}" alt="customer image"></a>
                                        </div>
                                    ...
                                    <div class="row media d-flex pt-15px pb-15px">
                                        <div class="col-lg-3 col-md-3 col-2 media-image align-self-center rounded">
                                            <a href="#"><img src="{{asset('assets_admin/img/products/p2.jpg')}}" alt="customer image"></a>
                                        </div>
                                        <div class="col-lg-9 col-md-9 col-10 media-body align-self-center ec-pos">
                                            <a href="#">
                                    ...
                                    <div class="row media d-flex pt-15px pb-15px">
                                        <div class="col-lg-3 col-md-3 col-2 media-image align-self-center rounded">
                                            <a href="#"><img src="{{asset('assets_admin/img/products/p3.jpg')}}" alt="customer image"></a>
                                        </div>
                                        <div class="col-lg-9 col-md-9 col-10 media-body align-self-center ec-pos">
                                            <a href="#">
    ...
    <!-- Common Javascript -->
    <script src="{{asset('assets_admin/plugins/jquery/jquery-3.5.1.min.js')}}"></script>
    <script src="{{asset('assets_admin/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('assets_admin/plugins/simplebar/simplebar.min.js')}}"></script>
    <script src="{{asset('assets_admin/plugins/jquery-zoom/jquery.zoom.min.js')}}"></script>
    <script src="{{asset('assets_admin/plugins/slick/slick.min.js')}}"></script>

    <!-- Chart -->
    <script src="{{asset('assets_admin/plugins/charts/Chart.min.js')}}"></script>
    <script src="{{asset('assets_admin/js/chart.js')}}"></script>

    <!-- Google map chart -->
    <script src="{{asset('assets_admin/plugins/charts/google-map-loader.js')}}"></script>
    <script src="{{asset('assets_admin/plugins/charts/google-map.js')}}"></script>

    <!-- Date Range Picker -->
    <script src="{{asset('assets_admin/plugins/daterangepicker/moment.min.js')}}"></script>
    <script src="{{asset('assets_admin/plugins/daterangepicker/daterangepicker.js')}}"></script>
    <script src="{{asset('assets_admin/js/date-range.js')}}"></script>

    <!-- Option Switcher -->
    <script src="{{asset('assets_admin/plugins/options-sidebar/optionswitcher.js')}}"></script>

    <!-- Ekka Custom -->
    <script src="{{asset('assets_admin/js/ekka.js')}}"></script>
</body>
