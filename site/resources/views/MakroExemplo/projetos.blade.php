    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <form method="POST" id="form_envia_curriculo" name="form_envia_curriculo" action="#" enctype="multipart/form-data">
                ...
                <div class="form-group required-field">
                    <label for="filesArquivosProjeto">Envie os arquivos do seu projeto</label><small>Envie no máximo 20 arquivos com o tamanho máximo de 15mb.</small>
                    <input type="file" class="form-control" id="filesArquivosProjeto" name="filesArquivosProjeto[]" required multiple>
                </div>

                <div class="form-group required-field">
                    <label for="mensagem">Escreva uma breve descrição do seu projeto</label>
                ...
                <div class="form-footer">
                    ...
                    <a href="javascript:enviarEmail()" class="btn btn-primary">Enviar projeto</a>
                </div>
            </form>
        </div>
        ...
        <script>
            function enviarEmail() {
                ...
                */
                ...
                if (document.getElementById('filesArquivosProjeto').value === '') {
                    document.getElementById('mensagemRetornoEmail').innerHTML = "Adicione seu projeto";
                    document.getElementById('mensagemRetornoEmail').style.display = "block";
                    return;
                }

                document.getElementById('mensagemRetornoEmail').innerHTML = "Aguarde o envio do seu projeto, estou anexando seu(s) arquivo(s)...";
                document.getElementById('mensagemRetornoEmail').style.display = "block";
                ...
                $.ajax({
                    ...
                    if (response === 'ok') {
                        document.getElementById('mensagemRetornoEmail').innerHTML = "Projeto enviado com sucesso";
                    } else {
                        document.getElementById('mensagemRetornoEmail').innerHTML = "Erro ao enviar seu projeto 1. Motivo: "+response;
                    }
                }).fail(function() {
                    //document.getElementById('mensagemRetornoEmail').innerHTML = "Erro ao enviar seu projeto";
                }).always(function() {
                    document.getElementById('mensagemRetornoEmail').innerHTML = "Projeto enviado com sucesso";
                });
            }
