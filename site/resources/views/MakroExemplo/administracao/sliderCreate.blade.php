...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Criar nova slider</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <small><code>Adicione um nome para identificar o slider.</code></small>
                            </div>
                            <div class="form-group">
                                <br>
                                ...
                                <small><code>Selecione uma imagem. 1920 X 500</code></small>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        </div>
                        <div class="col-sm-6">
                            <button type='submit' class='btn bg-gradient-success btn-block'>Adicionar nov slider</button>
                        </div>
