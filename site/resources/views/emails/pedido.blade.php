                                            ...
                                            <td class="text-services" style="text-align: left; padding-right:25px;">
                                                ...
                                                <div class="services-list">
                                                    <div class="text">
                                                        ...
                                                        @if ($user->tipopessoa == 'f')
                                                        <p>CPF: <strong>{{$user->cpf}}</strong></p>
                                                        @else
                                                        <p>CNPJ: <strong>{{$user->cnpj}}</strong></p>
                                                        @endif
                                                        <p>Telefone: <strong>{{$user->telefone}}</strong></p>
                                                        <p>WhatsApp: <strong>{{$user->whatsapp}}</strong></p>
                                                        <p>Endereço: <strong>{{$user->endereco}} {{$user->rua}} {{$user->complemento}} {{$user->bairro}} {{$user->cep}} {{$user->cidade}} {{$user->estado}}</strong></p>
                                                    </div>
                                                </div>
                                                <div class="services-list">
                                                    <div class="text">
                                                        ...
                                                        <table class="table table-cart">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                $listaprodutos = unserialize($listaprodutos);
                                                                ?>
