...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Editar promoção</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <section class="content">
        <div class="card">
            ...
            @endif
            <div class="card-body">
                <form method="POST" action="{{ route('promocoes.update' , $promocao->id) }}" enctype="multipart/form-data">
                    @csrf
                    <input name="_method" type="hidden" value="PUT">
                    <input type="hidden" id="get_id_produto" name="get_id_produto" value="{{$promocao->produto_id}}">
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="descricao" name="descricao" placeholder="" value="{{$promocao->descricao}}">
                            ...
                            <div class="form-group">
                                ...
                                <small><code>Caso não envie uma imagem a imagem atual não será modificada. 600 X 600</code></small>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        </div>
                        <div class="col-sm-6">
                            <button type='submit' class='btn bg-gradient-success btn-block'>Modificar promoção</button>
                        </div>
